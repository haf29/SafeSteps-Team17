                      ...
                      children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Icon(Icons.email, color: Colors.blue[600] ?? Colors.blue, size: 20),
                                    const SizedBox(width: 8),
                                    Text('Reset Password', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue[700] ?? Colors.blue)),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                Text('Enter your email to receive a password reset link.', style: TextStyle(color: Colors.blue[600] ?? Colors.blue, fontSize: 12)),
                        ...
                        if (!_isSignUp && !_showForgotPassword) ...[
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                const Text('Test Credentials:', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1E3A8A))),
  ...
  Widget _ruleRow(String text, bool ok) {
    return Row(
      children: [
        ...
        Text(text, style: TextStyle(color: ok ? Colors.green : Colors.grey[700] ?? Colors.grey)),
      ],
    );
  }
}
